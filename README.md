...
| Page | Description |
|:--|:--|
| About Us | Clinic story, mission, and team |
| All Products | Full product catalog (brushes, electrical accessories) |
| Courses | Educational courses for dental professionals |
| Case Studies | Real-world clinical case breakdowns |
...
```bash
git clone https://github.com/Aarishkhan12/32-SMILES.git
